...
#ifdef __APPLE__
    { .fcc = VLC_CODEC_H264, .get_opt = vlc_sout_renderer_GetVencAvcodecVTOption },
#endif
    { .fcc = VLC_CODEC_H264, .get_opt = vlc_sout_renderer_GetVencQSVH264Option },
    { .fcc = VLC_CODEC_H264, .get_opt = vlc_sout_renderer_GetVencX264Option },
    { .fcc = VLC_CODEC_VP8,  .get_opt = vlc_sout_renderer_GetVencVPXOption },
